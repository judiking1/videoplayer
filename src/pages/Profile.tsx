...
import { LogOut, Crown, User as UserIcon, ArrowLeft } from 'lucide-react';
                        ...
                        <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                            ...
                            {!isPro && (
                                <button
                                    ...
                                    className="mt-4 px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg font-semibold text-white hover:opacity-90 transition-opacity flex items-center gap-2"
                                >
                                    <Crown size={16} />
                                    Upgrade to Pro
                                </button>
